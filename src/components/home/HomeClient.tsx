...
const StatusIcon = ({ status, className = "" }: { status: string, className?: string }) => {
  switch (status) {
    case 'online':
      return (
        <svg viewBox="0 0 24 24" className={`fill-[#23a559] ${className}`}>
          <circle cx="12" cy="12" r="12" />
        </svg>
      );
    case 'dnd':
      return (
        <svg viewBox="0 0 24 24" className={`fill-[#ed4245] ${className}`}>
          <path d="M12 24C18.6274 24 24 18.6274 24 12C24 5.37258 18.6274 0 12 0C5.37258 0 0 5.37258 0 12C0 18.6274 5.37258 24 12 24ZM17 14.5H7V9.5H17V14.5Z" />
        </svg>
      );
    case 'idle':
      return (
        <svg viewBox="0 0 24 24" className={`fill-[#f0b232] ${className}`}>
    ...
    default:
      return (
        <svg viewBox="0 0 24 24" className={`fill-[#80848e] ${className}`}>
          <path d="M12 24C18.6274 24 24 18.6274 24 12C24 5.37258 18.6274 0 12 0C5.37258 0 0 5.37258 0 12C0 18.6274 5.37258 24 12 24ZM12 18.5C15.5899 18.5 18.5 15.5899 18.5 12C18.5 8.41015 15.5899 5.5 12 5.5C8.41015 5.5 5.5 8.41015 5.5 12C5.5 15.5899 8.41015 18.5 12 18.5Z" />
        </svg>
      );
  }
};
