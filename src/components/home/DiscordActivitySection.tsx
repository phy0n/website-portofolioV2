...
const SpotifyCard = ({
  ...
  return (
    <div className="flex flex-col w-full p-4 rounded-xl bg-[var(--home-card)]/30 backdrop-blur-sm border border-[var(--home-border)] text-left transition-all duration-300 hover:border-[var(--home-border)]">
