          ...
          <div className="grid gap-3">
            {SOCIAL_MEDIA.map((social, index) => (
              <a
                ...
                className="group flex items-center justify-between gap-4 rounded-3xl border border-[var(--home-border)] bg-[var(--home-card)]/30 backdrop-blur-sm p-4 transition-all hover:border-[var(--home-border)] hover:bg-[var(--home-card)]/80">
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-3">
            {CONTACT_INFO.map((contact, index) => (
              <div
                key={index}
                className="group flex items-start gap-4 rounded-3xl border border-[var(--home-border)] bg-[var(--home-card)]/30 backdrop-blur-sm p-5 transition-all hover:border-[var(--home-border)] hover:bg-[var(--home-card)]/80">
