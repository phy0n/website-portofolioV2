        ...
        {CONTACT_INFO.map((contact) => {
          ...
          return (
            <Wrapper
              ...
              className="group relative flex min-h-[220px] flex-col justify-between overflow-hidden rounded-[2rem] border border-[var(--home-border)] bg-[var(--home-card)]/30 backdrop-blur-sm p-6 transition-all duration-300 hover:border-[var(--home-border)]"
            >
