    ...
    <div className="w-full flex flex-col rounded-2xl shadow-2xl overflow-hidden relative" style={{ backgroundColor: '#121212' }}>
      ...
      <div className="px-6 pb-6 flex flex-col relative">
        ...
        <a
          ...
          className="w-full py-3 bg-red-500 hover:bg-orange-700 text-white font-bold text-[15px] rounded-xl transition-colors text-center shadow-lg active:scale-[0.98]">
          Join Server
        </a>
      </div>
    </div>
