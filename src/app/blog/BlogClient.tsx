              ...
              <div className="space-y-6 xs:space-y-8">
                {filteredBlogs.map((blog, index) => {
                  return (
                    ...
                    >
                      <article className="relative bg-black border border-white/10 hover:border-white/10 transition-all duration-300 overflow-hidden">
                        <div className="grid md:grid-cols-5 gap-0">
                          <div className="md:col-span-2 relative h-48 xs:h-56 sm:h-64 md:h-72 overflow-hidden">
                            ...
                            <div className="absolute top-3 xs:top-4 right-3 xs:right-4 bg-black/80 backdrop-blur-sm border border-white/10 px-2 xs:px-3 py-1 xs:py-1.5">
                              <div className="flex items-center gap-1.5 xs:gap-2">
                                <BookOpen className="w-3 h-3 xs:w-3.5 xs:h-3.5 text-[var(--home-accent)]" />
                                <span className="text-[10px] xs:text-xs text-[var(--home-muted)]">Story #{index + 1}</span>
                              </div>
                            </div>
                          </div>
